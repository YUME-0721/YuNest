            ...
            <div className="space-y-4 pt-4 border-t border-slate-50">
              ...
              <div className="flex flex-col gap-3 pt-2">
                ...
                <a
                  ...
                  target="_blank"
                  rel="noreferrer"
                  className="flex items-center gap-3 p-3.5 rounded-2xl bg-slate-900 text-white hover:bg-slate-800 transition-all group/repo shadow-md shadow-slate-200 active:scale-95"
                >
