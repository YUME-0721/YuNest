<div align="center">
  ...
  <p>因为 YuNest 是一个纯前端的静态应用，你可以非常轻松地将其跑在本地或是部署在<a href="#☁️-模块二静态托管云部署-cloud-deployment">任何静态托管云服务</a>上。</p>
</div>
...
### ☁️ 模块二：静态托管云部署 (Cloud Deployment)
...
4. **设置环境变量 (关键)**:
   - 在部署平台的 **Environment Variables** 设置中，新增 `VITE_ADMIN_PASSWORD` 变量（这将作为您唯一的后台认证凭证，请务必设置）。
5. **🚀 针对 Cloudflare 的深度优化 (必做)**:
